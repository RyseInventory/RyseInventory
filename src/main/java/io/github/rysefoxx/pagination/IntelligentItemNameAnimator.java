    ...
    public static class Builder {
        ...
        public Builder item(@NotNull IntelligentItem intelligentItem) {
            ...
            this.displayName = itemStack.hasItemMeta() && itemStack.getItemMeta().hasDisplayName()
                    ? ChatColor.translateAlternateColorCodes('&',LegacyComponentSerializer.legacyAmpersand().serialize(Objects.requireNonNull(itemStack.getItemMeta().displayName())))
         ...
         * @return The Builder to perform further editing.
         */
        public Builder copy(@NotNull IntelligentItemNameAnimator preset) {
            this.preset = preset;
            return this;
        }
         ...
         */
        public IntelligentItemNameAnimator build(@NotNull InventoryContents contents) throws IllegalArgumentException, NullPointerException {
            if (this.preset != null) {
