...
public class SlideAnimation {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(@NotNull SlideAnimation preset) {
            this.preset = preset;
            return this;
        }
         ...
         * @return The Builder to perform further editing.
         */
        public Builder direction(@NotNull AnimatorDirection direction) {
         ...
         * @throws IllegalArgumentException if slot is > 53
         */
        public Builder from(Integer @NotNull ... slots) throws IllegalArgumentException {
         ...
         * @throws IllegalArgumentException if row is > 5 or if column > 8
         */
        public Builder from(Integer @NotNull [] rows, Integer @NotNull [] columns) throws IllegalArgumentException {
         ...
         */
        public Builder from(@NotNull List<Integer> slots) throws IllegalArgumentException {
         ...
         * @throws IllegalArgumentException if row is > 5 or if column > 8
         */
        public Builder from(@NotNull List<Integer> rows, @NotNull List<Integer> columns) throws IllegalArgumentException {
         ...
         * @throws IllegalArgumentException if slot is > 53
         */
        public Builder to(Integer @NotNull ... slots) throws IllegalArgumentException {
            for (Integer slot : slots) {
                to(slot);
            }
            return this;
         ...
         * @throws IllegalArgumentException if row is > 5 or if column > 8
         */
        public Builder to(Integer @NotNull [] rows, Integer @NotNull [] columns) throws IllegalArgumentException {
            Preconditions.checkArgument(rows.length == columns.length, "Rows must have the same length as columns.");
         ...
         * @throws IllegalArgumentException if slot is > 53
         */
        public Builder to(@NotNull List<Integer> slots) throws IllegalArgumentException {
         ...
         * @throws IllegalArgumentException if row is > 5 or if column > 8
         */
        public Builder to(@NotNull List<Integer> rows, @NotNull List<Integer> columns) throws IllegalArgumentException {
            Preconditions.checkArgument(rows.size() == columns.size(), "Rows must have the same length as columns.");
         ...
         * @return The Builder to perform further editing.
         */
        public Builder item(@NotNull IntelligentItem item) {
            ItemStack itemStack = item.getItemStack();
            ItemMeta itemMeta = itemStack.getItemMeta();
            PersistentDataContainer container = itemMeta.getPersistentDataContainer();

            container.set(new NamespacedKey(javaPlugin, "RYSEINVENTORY_SLIDE_ANIMATION_KEY"), PersistentDataType.STRING, UUID.randomUUID().toString());
            itemStack.setItemMeta(itemMeta);

            item.update(itemStack);
         ...
         * @return The Builder to perform further editing.
         */
        public Builder item(IntelligentItem @NotNull ... items) {
         ...
         * @return The Builder to perform further editing.
         */
        public Builder item(@NotNull List<IntelligentItem> items) {
    ...
    private void animateByTyp(@NotNull JavaPlugin plugin) {
    ...
    private void animateDiagonalTopBottomLeft(@NotNull JavaPlugin plugin) {
    ...
    private void animateDiagonalTopBottomRight(@NotNull JavaPlugin plugin) {
        for (int i = 0; i < this.items.size(); i++) {
            boolean moreDelay = i != 0 && Objects.equals(this.from.get(i), this.from.get(i - 1));
    ...
    private void animateHorizontal(@NotNull JavaPlugin plugin) {
        for (int i = 0; i < this.items.size(); i++) {
            boolean moreDelay = i != 0 && Objects.equals(this.from.get(i), this.from.get(i - 1));
    ...
    private void animateVertical(@NotNull JavaPlugin plugin) {
        for (int i = 0; i < this.items.size(); i++) {
            boolean moreDelay = i != 0 && Objects.equals(this.from.get(i), this.from.get(i - 1));
    ...
    private @NotNull String getKey(@NotNull IntelligentItem item) {
        ItemStack previousItemStack = item.getItemStack();
        ItemMeta itemMeta = previousItemStack.getItemMeta();
        PersistentDataContainer container = itemMeta.getPersistentDataContainer();

        return Objects.requireNonNull(container.get(new NamespacedKey(javaPlugin, "RYSEINVENTORY_SLIDE_ANIMATION_KEY"), PersistentDataType.STRING));
    }
